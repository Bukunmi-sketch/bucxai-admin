            ...
            <div class="card-body myTab">
                ...
                <ul class="nav nav-tabs" id="profileTabs" role="tablist">
                    <li class="nav-item fw-bold">
                        <a class="nav-link {{ $activeTab === 'data-topup' ? 'active' : '' }}" wire:click.prevent="switchTab('data-topup')" href="#">
                            Data Topup
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ $activeTab === 'buy-airtime' ? 'active' : '' }}" wire:click.prevent="switchTab('buy-airtime')" href="#">
                            Airtime Purchase
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ $activeTab === 'bill-payment' ? 'active' : '' }}" wire:click.prevent="switchTab('bill-payment')" href="#">
                            Bill Payment
                        </a>
                    </li>
                    ...
                    <table id="data-table3" class="table table-bordered text-nowrap mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-dark fw-semibold">{{ number_format($content->amount-$content->discountAmount, 2) }}</td>
                                <td>
                                    <span class="badge {{ $content->status === 'success' ? 'bg-success' : ($content->status === 'pending' ? 'bg-warning' : 'bg-danger') }}">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Are you sure you want to decline this transaction <strong>{{ ucfirst($content->product_name) }}</strong>?
                                                </div>
                                      ...
                                      <div class="modal fade" id="confirmApprovalModal-{{ $content->id }}" tabindex="-1" aria-labelledby="confirmApprovalModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Are you sure you want to approve  this transaction <strong>{{ ucfirst($content->product_name) }}</strong>?
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
