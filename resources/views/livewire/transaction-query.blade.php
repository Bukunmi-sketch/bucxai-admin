            ...
            <form wire:submit.prevent="searchBasedOnQuery">
                <div class="row align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="product_entity_id" class="form-control form-select" wire:model.defer="product_entity_id">
                        ...
                        <table id="data-table3" class="table table-bordered text-nowrap mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-dark fw-semiboldHere">
                                        {{ number_format($content->amount, 2) }}
                                    </td>
                                    <td class="text-dark fw-semibold">{{ number_format($content->amount-$content->discountAmount, 2) }}</td>
                                    <td class="fw-semibold">
                                        <span class="badge bg-{{ $content->status == 'success' ? 'success' : ($content->status == 'pending' ? 'warning' : 'danger') }}">
