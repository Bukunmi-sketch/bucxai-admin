        ...
        <div class="col-xl-3 col-md-6 col-lg-6 col-sm-6">
            <div class="card card-img-holder">
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <span class="pie" data-peity='{ "fill": ["#e24934", "#ebe9f7"]}'>0.52/1.561</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 col-lg-6 col-sm-6">
            <div class="card card-img-holder">
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <span class="pie" data-peity='{ "fill": ["#ff7708", "#ebe9f7"]}'>226/360</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 col-lg-6 col-sm-6">
            <div class="card card-img-holder">
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <span class="pie" data-peity='{ "fill": ["#f35e90", "#ebe9f7"]}'>226/360</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-xl-3 col-md-6 col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="text-muted-dark"><i class="fa fa-arrow-circle-o-up  text-success"></i> 10%
                        Increase</span>
                </div>
            </div>
        </div><!-- col end -->
        <div class="col-lg-6 col-xl-3 col-md-6 col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="text-muted-dark"><i class="fa fa-arrow-circle-o-down  text-danger"></i> 8%
                        Decrease</span>
                </div>
            </div>
        </div><!-- col end -->
        <div class="col-lg-6 col-xl-3 col-md-6 col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="text-muted-dark"><i class="fa fa-arrow-circle-o-up  text-success"></i> 15%
                        Increase</span>
                </div>
            </div>
        </div><!-- col end -->
        ...
        <div class="col-sm-12 col-lg-6 col-md-6 col-xl-6">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted-dark"><span class="text-purple"><i
                                class="fa fa-arrow-up text-success mx-1"></i>23%
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="progress progress-sm mt-2">
                        <div class="progress-bar progress-bar-striped h-2 progress-bar-animated bg-primary w-35">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="progress progress-sm mt-2">
                        <div class="progress-bar progress-bar-striped h-2 progress-bar-animated bg-warning w-55">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="progress progress-sm mt-2">
                        <div class="progress-bar progress-bar-striped h-2 progress-bar-animated bg-info w-70">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="progress progress-sm mt-2">
                        <div class="progress-bar progress-bar-striped h-2 progress-bar-animated bg-secondary w-85">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card text-center bg-gradient-primary text-white">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-center"><i
                            class="si si-arrow-up-circle text-white"></i> <span class="text-white mx-1">25%</span>
                        Increase</div>
                </div>
            </div>
        </div><!-- col end -->
        <div class="col-sm-6 col-md-6 col-xl-3 col-lg-6">
            <div class="card text-center bg-gradient-success text-white">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-center"><i
                            class="si si-arrow-up-circle text-white"></i> <span class="text-white mx-1">54%</span>
                        Increase</div>
                </div>
            </div>
        </div><!-- col end -->
        <div class="col-sm-6 col-md-6 col-xl-3 col-lg-6">
            <div class="card text-center bg-gradient-info text-white">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-center"><i
                            class="si si-arrow-up-circle text-white"></i> <span class="text-white mx-1">22%</span>
                        Increase</div>
                </div>
            </div>
        </div><!-- col end -->
        <div class="col-sm-6 col-md-6 col-xl-3 col-lg-6">
            <div class="card text-center bg-gradient-danger text-white">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-center"><i
                            class="si si-arrow-up-circle text-white"></i> <span class="text-white mx-1">12%</span>
                        Increase</div>
                </div>
            </div>
        </div><!-- col end -->
            ...
            <div class="card card-img- holder">
                ...
                <div class="card-footer">
                    <p class="text-muted mb-0 d-flex align-items-center"><i
                            class="si si-arrow-down-circle text-warning me-1" aria-hidden="true"></i>Daily Orders</p>
                </div>
            </div>
        </div><!-- col end -->
        <div class="col-sm-6 col-lg-6 col-md-6 col-xl-3">
        ...
        <div class="col-sm-6 col-lg-6 col-md-6 col-xl-3">
            <div class="card">
                ...
                <div class="card-footer">
                    <p class="text-muted mb-0 d-flex align-items-center"><i class="si si-check me-1 text-primary"></i>
                        Recent History
                    </p>
                </div>
            </div>
        ...
        <div class="col-6 col-sm-6 col-lg-3">
            <div class="card">
                <div class="card-body text-center">
                    <div class="h1 m-0"><i class="mdi mdi-cash-multiple text-primary mx-2"></i><strong>82</strong></div>
            ...
            <div class="card bg-primary">
                <div class="card-body">
                    <div class="d-flex no-block align-items-center">
                        ...
                        <div class="ms-auto">
                            <span class="text-white display-6"><i class="fa fa-file-text-o fs-1"></i></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-info">
                <div class="card-body">
                    <div class="d-flex no-block align-items-center">
                        ...
                        <div class="ms-auto">
                            <span class="text-white display-6"><i class="fa fa-signal fs-1"></i></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-success">
                <div class="card-body">
                    <div class="d-flex no-block align-items-center">
                        ...
                        <div class="ms-auto">
                            <span class="text-white display-6"><i class="fa fa-usd fs-1"></i></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-danger">
                <div class="card-body">
                    <div class="d-flex no-block align-items-center">
                        ...
                        <div class="ms-auto">
                            <span class="text-white display-6"><i class="fa fa-newspaper-o fs-1"></i></span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="mt-7 chart-circle chart-circle-md donutShadow" data-value="0.67"
                                data-thickness="20" data-color="#e24934 ">
                ...
                <div class="">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="mt-7 chart-circle chart-circle-md donutShadow" data-value="0.67"
                                data-thickness="20" data-color="#32cafe ">
                                <div class="chart-circle-value fs"><i class="fa fa-envelope-open-o"></i>
                                </div>
                            </div>
                            <div class="card-body mt-4">
                                <div class="d-flex  align-items-center">
                ...
                <div class="">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="mt-7 chart-circle chart-circle-md donutShadow" data-value="0.67"
                                data-thickness="20" data-color="#fdb901 ">
                ...
                <div class="">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="mt-7 chart-circle chart-circle-md donutShadow" data-value="0.67"
                                data-thickness="20" data-color="#5ed84f ">
    ...
    <div class="row">
            ...
            <div class="card  mb-5">
                <div class="card-body">
                    <div class="media mt-0">
                        <img src="{{ asset('build/assets/images/users/female/19.jpg') }}" alt="Generic placeholder image"
        ...
        <div class="col-lg-12 col-xl-4 col-sm-12">
            <div class="card mb-5">
                <div class="card-body">
                    <div class="media mt-0">
                        <img src="{{ asset('build/assets/images/users/male/32.jpg') }}" alt="Generic placeholder image"
                            class="avatar brround avatar-md me-3">
                        <div class="media-body lh-1">
        ...
        <div class="col-lg-12 col-xl-4 col-sm-12">
            <div class="card mb-5">
                <div class="card-body">
                    <div class="media mt-0">
                        <img src="{{ asset('build/assets/images/users/female/21.jpg') }}" alt="Generic placeholder image"
                            class="avatar brround avatar-md me-3">
                        <div class="media-body lh-1">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-4 align-items-center br-5 mb-3">
                        <div class="d-flex justify-content-center align-items-center">
                            <img src="{{ asset('build/assets/images/users/female/20.jpg') }}"
                                class="avatar avatar-md br-7 cover-image" alt="person-image">
                            <div class="p-1 ms-3">
                    ...
                    <div class="d-flex justify-content-between mb-4 align-items-center br-5 mb-3">
                        <div class="d-flex justify-content-center align-items-center">
                            <img src="{{ asset('build/assets/images/users/male/14.jpg') }}"
                                class="avatar avatar-md br-7 cover-image" alt="person-image">
                            <div class="p-1 ms-3">
                                <h6 class="mb-1 fw-semibold">Jordon Matey</h6>
                                <p class="mb-0 text-muted fs-12">Matey@gmail.com</p>
                            ...
                            <tbody>
                                <tr class="border-bottom">
                                    <td class="ps-5 d-flex align-items-center border-bottom-0">
                                        <img alt="browser-image" class="avatar br-7 me-2"
                                            src="{{ asset('build/assets/images/browsers/1.png') }}">
                                    ...
                                    <td class="text-end pe-5">
                                        <span class="fw-semibold"><i
                                                class="fe fe-arrow-up text-success me-1"></i>86.29%</span>
                                ...
                                <tr class="border-bottom">
                                    <td class="ps-5 d-flex align-items-center border-bottom-0">
                                        <img alt="browser-image" class="avatar br-7 me-2"
                                            src="{{ asset('build/assets/images/browsers/4.png') }}">
                                    ...
                                    <td class="text-end pe-5">
                                        <span class="fw-semibold"><i
                                                class="fe fe-arrow-down text-danger me-1"></i>42.05%</span>
                                        <div class="progress progress-md h-1">
                                            <div
                                                class="progress-bar progress-bar-striped progress-bar-animated bg-primary w-40">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr class="border-bottom">
                                    <td class="ps-5 d-flex align-items-center border-bottom-0">
                                        <img alt="browser-image" class="avatar br-7 me-2"
                                            src="{{ asset('build/assets/images/browsers/5.png') }}">
                                    ...
                                    <td class="text-end pe-5">
                                        <span class="fw-semibold"><i
                                                class="fe fe-arrow-up text-success me-1"></i>30.52%</span>
                                        <div class="progress progress-md h-1">
                                            <div
                                                class="progress-bar progress-bar-striped progress-bar-animated bg-primary w-35">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr class="border-bottom">
                                    <td class="ps-5 d-flex align-items-center border-bottom-0">
                                        <img alt="browser-image" class="avatar br-7 me-2"
                                            src="{{ asset('build/assets/images/browsers/3.png') }}">
                                    ...
                                    <td class="text-end pe-5">
                                        <span class="fw-semibold"><i
                                                class="fe fe-arrow-up text-success me-1"></i>26.65%</span>
                                        <div class="progress progress-md h-1">
                                            <div
                                                class="progress-bar progress-bar-striped progress-bar-animated bg-primary w-25">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr class="border-bottom-0">
                                    <td class="ps-5 d-flex align-items-center border-bottom-0">
                                        <img alt="browser-image" class="avatar br-7 me-2"
                                            src="{{ asset('build/assets/images/browsers/2.png') }}">
                                    ...
                                    <td class="text-end pe-5">
                                        <span class="fw-semibold"><i
                                                class="fe fe-arrow-down text-danger me-1"></i>34.12%</span>
                                        <div class="progress progress-md h-1">
                                            <div
                                                class="progress-bar progress-bar-striped progress-bar-animated bg-primary w-35">
                                            </div>
                ...
                <div class="card-body p-0">
                    <div class="list-group list-lg-group list-group-flush">
                        ...
                        <a class="list-group-item list-group-item-action py-4" href="javascript:void(0);">
                            <div class="media mt-0">
                                <img class="avatar-lg rounded-circle me-3"
                                    src="{{ asset('build/assets/images/users/male/25.jpg') }}" alt="Image description">
                                <div class="media-body">
                                    <div class="d-md-flex align-items-center">
                                        <h4 class="mb-1 text-dark">
                                            Steven Fisher
                        ...
                        <a class="list-group-item list-group-item-action py-4" href="javascript:void(0);">
                            <div class="media mt-0">
                                <img class="avatar-lg rounded-circle me-3"
                                    src="{{ asset('build/assets/images/users/male/33.jpg') }}" alt="Image description">
                                <div class="media-body">
                                    <div class="d-md-flex align-items-center">
                                        <h4 class="mb-1 text-dark">
                                            Steven Fisher
                    ...
                    <div class="list-group projects-list">
                        <a href="javascript:void(0);"
                            ...
                            <div class="d-flex w-100 justify-content-between">
                                ...
                                <span class="text-danger badge bg-danger-transparent my-auto"><i
                                        class="fa fa-caret-down me-1"></i>5
                                    days
                                    ago</span>
                            </div>
                        ...
                        <a href="javascript:void(0);"
                            ...
                            <div class="d-flex w-100 justify-content-between">
                                ...
                                <small class="text-success badge bg-success-transparent my-auto"><i
                                        class="fa fa-caret-up me-1"></i>2
                                    days
                                    ago</small>
                            </div>
                        ...
                        <a href="javascript:void(0);"
                            ...
                            <div class="d-flex w-100 justify-content-between">
                                ...
                                <small class="text-danger badge bg-danger-transparent my-auto"><i
                                        class="fa fa-caret-down me-1"></i>1
                                    days
                                    ago</small>
                            </div>
                        ...
                        <a href="javascript:void(0);"
                            ...
                            <div class="d-flex w-100 justify-content-between">
                                ...
                                <small class="text-success badge bg-success-transparent my-auto"><i
                                        class="fa fa-caret-up me-1"></i>10
                                    days
                                    ago</small>
                            </div>
