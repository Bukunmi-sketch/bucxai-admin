        ...
        <div class="col-lg-4 col-xl-3">
            <div class="card mb-4">
                <div class="card-header border-bottom">
                    <a class="btn btn-outline-primary btn-block py-2" id="btnCompose" data-bs-target="#Vertically"
                        data-bs-toggle="modal" href="javascript:void(0);"><i class="fa fa-plus me-2"></i>Upload Files</a>
                </div>
                <div class="card-body">
                ...
                <div class="card-body br-7 upgrade-storage bg-primary-transparent">
                    <a href="javascript:void(0)">
                        <div class="upgrade-main text-center">
                            <svg class="mb-1" xmlns="http://www.w3.org/2000/svg" style="width: 3rem;"
                        ...
                        <a href="{{ url('filemanager-details') }}">
                            <div class="card-body">
                                <div class="file-type my-1">
                                    <svg class="file-manager-icon w-icn me-2" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <a href="javascript:void(0);">
                            <div class="card-body">
                                <div class="file-type my-1">
                                    <svg class="file-manager-icon w-icn me-2" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <rect width="9" height="9" x="2" y="2" fill="#e6647f" rx="1" />
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Add file</h6><button aria-label="Close" class="btn-close"
