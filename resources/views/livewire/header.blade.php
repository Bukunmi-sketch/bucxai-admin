    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal" href="{{ url('/') }}">
                <img src="https://res.cloudinary.com/morshudlhgmo/image/upload/v1711503888/Bundlegram/350_100_yoaddn.png" class="header-brand-img main-logo"
                    alt="Sparic logo">
                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            {{-- <div class="dropdown d-flex message">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <div class="text-center dropdown-footer">
                                        <a class="btn btn-primary btn-sm btn-block text-center"
                                            href="{{ url('chat') }}">MARK ALL AS READ</a>
                                    </div>
                                </div>
                            </div> --}}
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow"
                                    ...
                                    <div class="drop-heading">
                                        <div class="text-center">
                                            ...
                                            <span
                                                class="text-muted fs-12">{{ Auth::guard('admin')->user()->role == 'admin' ? 'Administrator' : 'Staff' }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <form wire:submit.prevent="logout">
                                        <button class="dropdown-item text-dark fw-semibold" type="submit">
