                            ...
                            <div class="page-header d-sm-flex d-block">
                                ...
                                <div class="ms-auto">
                                    <div>
                                        ...
                                        {{-- <a href="javascript:void(0);" class="btn bg-warning-transparent text-warning btn-sm" data-bs-toggle="tooltip" title="" data-bs-placement="bottom" data-bs-original-title="Add New"> Add New <span> <i class="fa fa-plus"></i> </span> </a> --}}
                                    </div>
                                </div>
                            </div>
                            <!-- END PAGE HEADER -->
                                                ...
                                                <table id="data-table3" class="table table-bordered text-nowrap mb-0">
                                                    ...
                                                    <tbody>
                                                        @foreach($users as $user)
                                                            <tr>
                                                                {{-- <td>
                                                                    <button type="button" class="btn btn-sm bg-info-transparent"> <a href="{{ route('admin.view-users', ['id' => $user->id]) }}"><i class="fe fe-edit text-info"></i> View </a></button>

                                                                    @if($user->status == 'active')
                                                                        <button wire:click="toggleBan('ban', {{ $user->id }})" type="button" class="btn btn-sm bg-warning-transparent"> <i class="fe fe-trash-2 text-danger"></i> Ban </button>
                                                                        @else
                                                                        <button wire:click="toggleBan('unban',{{ $user->id }})"  wire:confirm="Are you sure want to activate the item?" type="button" class="btn btn-sm bg-success-transparent"> <i class="fe fe-trash-2 text-danger"></i> UnBan </button>
                                                                        @endif
                                                                    <button class="btn btn-sm bg-danger-transparent badge" type="button">Edit</button>
                                                                    <button class="btn btn-sm btn-primary badge" type="button">Delete</button>
                                                                </td> --}}
