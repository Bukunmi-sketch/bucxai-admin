...
{{-- @section('content') --}}
                            ...
                            <div class="page-header d-sm-flex d-block">
                                <ol class="breadcrumb mb-sm-0 mb-3">
                                    <!-- breadcrumb -->
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">{{ $slug ?? null }}</a></li>
                                    ...
                                    <div class="card">
                                        <div class="card-body single-productslide">
                                            ...
                                            <div class="product-gallery-data mb-0">
                                                <h3 class="mb-3 fw-semibold">{{ ucfirst($product->product_name) }} ({{ ucfirst($product->type) }} ) </h3>
                                                <div class="mb-3">
                                                    {{-- <span class="fw-semibold h1 text-dark">$56</span> --}}
                                                    <span class="text-primary ms-2">{{ ucfirst($product->type) }}</span>
                                                </div>
                                                <h6 class="fw-semibold mt-3">DESCRIPTION</h6>
                                                <p class="text-muted">{{ ucfirst($product->product_description) }} ({{ ucfirst($product->trans_desc) }})</p>
                                                <dl class="product-gallery-data1">
                                                    <dt>Color</dt>
                                                    <dd>{{ ucfirst($product->service_id) }}</dd>
                                                </dl>
                                                <dl class="product-gallery-data1">
                                                    <dt>Status</dt>
                                                    <dd> <span>
                                                        @if($product->status == '1')
                                                        <span class="badge bg-success text-white" style="padding: 0.2rem 0.5rem;">  Active</span>
                                                      @elseif($product->status == '0')
                                                          <button class="btn btn-sm btn-primary badge" type="button"> <span class="badge bg-danger text-white" style="padding: 0.2rem 0.5rem;">De-activate</span></button>
                                                      @endif</dd>
                                                </dl>
                                                <dl class="product-gallery-data1">
                                                    <dt>Created at</dt>
