                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="d-flex">
                                <div>
                                    <div class="mb-0 fw-semibold text-dark">Total Clients</div>
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="d-flex">
                                <div>
                                    <div class="mb-0 fw-semibold text-dark">Clients BVN Verified</div>
                                    <h3 class="mt-1 mb-1 text-dark fw-semibold">2000</h3>
                                    {{-- <div class="text-muted fs-12 mt-2"><i
                                            class="fe fe-arrow-up-right text-success me-1"></i>
                                ...
                                <i
                                    class="ri-thumb-up-line ms-auto fs-5 my-auto bg-primary-transparent p-3 br-7 text-primar"></i>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-6">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="d-flex">
                                <div>
                                    <div class="mb-0 fw-semibold text-dark">Team Member</div>
                                    <h3 class="mt-1 mb-1 text-dark fw-semibold">6</h3>
                                    {{-- <div class="text-muted fs-12 mt-2"><i
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="d-flex">
                                <div>
                                    <div class="mb-0 fw-semibold text-dark">Opened Support</div>
                                    <h3 class="mt-1 mb-1 text-dark fw-semibold">100</h3>
                            ...
                            <tbody class="text-dark">
                                <tr class="border-bottom">
                                    <td class="ps-5 d-flex align-items-center border-bottom-0">
                                        <img src="{{ asset('build/assets/images/flag-images/2.png') }}"
                                            class="avatar avatar-sm br-7" alt="country-image">
                                        <p class="mb-0 mx-2">Canada</p>
                                    </td>
                                    <td>
                                        <a href="javascript:void(0);"
                                            class="fw-semibold d-flex align-items-center text-dark">
                                ...
                                <tr class="border-bottom">
                                    <td class="ps-5 d-flex align-items-center border-bottom-0">
                                        <img src="{{ asset('build/assets/images/flag-images/3.png') }}"
                                            class="avatar avatar-sm br-7" alt="country-image">
                                ...
                                <tr class="border-bottom">
                                    <td class="ps-5 d-flex align-items-center border-bottom-0">
                                        <img src="{{ asset('build/assets/images/flag-images/1.png') }}"
                                            class="avatar avatar-sm br-7" alt="country-image">
                                ...
                                <tr class="border-bottom">
                                    <td class="ps-5 d-flex align-items-center border-bottom-0">
                                        <img src="{{ asset('build/assets/images/flag-images/5.png') }}"
                                            class="avatar avatar-sm br-7" alt="country-image">
                                ...
                                <tr class="border-bottom">
                                    <td class="ps-5 d-flex align-items-center border-bottom-0">
                                        <img src="{{ asset('build/assets/images/flag-images/6.png') }}"
                                            class="avatar avatar-sm br-7" alt="country-image">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="dropdown">
                        <button type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                            class="btn btn-sm btn-primary-light fw-semibold">
        ...
        <div class="col-xl-3 col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-footer d-flex justify-content-evenly">
                    <div>
                        <h6 class="mb-0 text-dark fw-semibold d-flex justify-content-center mb-1"><i
                                class="fe fe-airplay text-primary mx-1"></i>40.32%</h6>
                        <p class="text-muted ms-2 mb-0">Desktop</p>
                    </div>
                    <div>
                        <h6 class="mb-0 text-dark fw-semibold d-flex justify-content-center mb-1"><i
                                class="fe fe-smartphone text-secondary mx-1"></i>10.73%</h6>
                        <p class="text-muted ms-2 mb-0">Mobile</p>
                    </div>
                    <div>
                        <h6 class="mb-0 text-dark fw-semibold d-flex justify-content-center mb-1"><i
                                class="fe fe-tablet text-pink mx-1"></i>14.12%</h6>
                        ...
                        <table id="data-table3" class="table table-bordered text-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img alt="person-picture" class="avatar avatar-sm cover-image br-7 me-2"
                                ...
                                <tr>
                                    ...
                                    <td><span
                                            class="badge badge-warning-transparent text-warning fw-semibold">Limited</span>
                                    </td>
                                    <td>
                                        <button type="button" class="btn bg-info-transparent">
                                            <i class="fe fe-edit text-info"></i>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img alt="person-picture" class="avatar avatar-sm cover-image br-7 me-2"
                                                src="{{ asset('build/assets/images/products/13.jpg') }}">
                                    ...
                                    <td class="text-dark fw-semibold">Cash on delivered</td>
                                    <td><span class="badge badge-danger-transparent text-danger fw-semibold">No
                                            stock</span></td>
                                    <td>
                                        <button type="button" class="btn bg-info-transparent">
                                            <i class="fe fe-edit text-info"></i>
                                        ...
                                        <div class="d-flex border-bottom-0">
                                            <div>
                                                <span class="avatar avatar-sm me-2"><img
                                                        src="{{ asset('build/assets/images/products/16.jpg') }}"
                                                        alt="img" class="br-7 cover-image"></span>
                                            </div>
                                            <div class="flex-1 my-auto">
                                                <h6 class="mb-0 fs-14 fw-semibold text-dark">HP 200 Mouse &amp; Wireless
                                                    Headphones</h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-dark fw-semibold">Cash on delivered</td>
                                    <td><span
                                            class="badge badge-success-transparent text-success fw-semibold">Available</span>
                                    </td>
                                    <td>
                                        <button type="button" class="btn bg-info-transparent">
                                            <i class="fe fe-edit text-info"></i>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img alt="person-picture" class="avatar avatar-sm cover-image br-7 me-2"
                                                src="{{ asset('build/assets/images/products/17.jpg') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img alt="person-picture" class="avatar avatar-sm cover-image br-7 me-2"
                                                src="{{ asset('build/assets/images/products/6.jpg') }}">
