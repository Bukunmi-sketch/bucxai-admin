    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/assets/js/dashboardChart.js',


                // 'resources/css/iconfonts/animated.css',
                // 'resources/css/iconfonts/icons.css',
                // 'resources/js/jquery.min.js',
                // 'resources/js/popper.min.js',
                // 'resources/js/bootstrap.min.js',
                // 'resources/js/moment.min.js',
                // 'resources/js/breaking-news-ticker.min.js',
                // 'resources/js/sticky.js',
                // 'resources/js/switcher-styles.js',
